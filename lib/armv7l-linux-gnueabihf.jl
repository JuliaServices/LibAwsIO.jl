...
function Base.getproperty(x::Ptr{pthread_cond_t}, f::Symbol)
    f === :__data && return Ptr{__JL_Ctag_709}(x + 0)
...
struct __JL_Ctag_722
    data::NTuple{116, UInt8}
end

function Base.getproperty(x::Ptr{__JL_Ctag_722}, f::Symbol)
    f === :_pad && return Ptr{NTuple{29, Cint}}(x + 0)
    f === :_kill && return Ptr{__JL_Ctag_723}(x + 0)
    f === :_timer && return Ptr{__JL_Ctag_724}(x + 0)
    f === :_rt && return Ptr{__JL_Ctag_725}(x + 0)
    f === :_sigchld && return Ptr{__JL_Ctag_726}(x + 0)
    f === :_sigfault && return Ptr{__JL_Ctag_727}(x + 0)
    f === :_sigpoll && return Ptr{__JL_Ctag_728}(x + 0)
    f === :_sigsys && return Ptr{__JL_Ctag_729}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::__JL_Ctag_722, f::Symbol)
    r = Ref{__JL_Ctag_722}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_722}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_722}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{siginfo_t}, f::Symbol)
    ...
    f === :_sifields && return Ptr{__JL_Ctag_722}(x + 12)
    return getfield(x, f)
end
...
struct __JL_Ctag_716
    data::NTuple{4, UInt8}
end

function Base.getproperty(x::Ptr{__JL_Ctag_716}, f::Symbol)
    f === :scheduled && return Ptr{Bool}(x + 0)
    f === :reserved && return Ptr{Csize_t}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::__JL_Ctag_716, f::Symbol)
    r = Ref{__JL_Ctag_716}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_716}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_716}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_task}, f::Symbol)
    ...
    f === :abi_extension && return Ptr{__JL_Ctag_716}(x + 32)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{aws_channel_task}, f::Symbol)
    ...
    f === :task_fn && return Ptr{Ptr{aws_channel_task_fn}}(x + 40)
    f === :arg && return Ptr{Ptr{Cvoid}}(x + 44)
    f === :type_tag && return Ptr{Ptr{Cchar}}(x + 48)
    f === :node && return Ptr{aws_linked_list_node}(x + 52)
    return getfield(x, f)
end
...
struct __JL_Ctag_733
    data::NTuple{4, UInt8}
end

function Base.getproperty(x::Ptr{__JL_Ctag_733}, f::Symbol)
    f === :fd && return Ptr{Cint}(x + 0)
    f === :handle && return Ptr{Ptr{Cvoid}}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::__JL_Ctag_733, f::Symbol)
    r = Ref{__JL_Ctag_733}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_733}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_733}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_io_handle}, f::Symbol)
    f === :data && return Ptr{__JL_Ctag_733}(x + 0)
...
function Base.getproperty(x::Ptr{__JL_Ctag_714}, f::Symbol)
...
function Base.getproperty(x::__JL_Ctag_714, f::Symbol)
    r = Ref{__JL_Ctag_714}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_714}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_714}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_async_input_stream_tester}, f::Symbol)
    ...
    f === :synced_data && return Ptr{__JL_Ctag_714}(x + 104)
...
function s_print_stack_trace(sig, sig_info, user_data)
    ccall((:s_print_stack_trace, libaws_c_io), Cvoid, (Cint, Ptr{siginfo_t}, Ptr{Cvoid}), sig, sig_info, user_data)
end
...
function Base.getproperty(x::Ptr{__JL_Ctag_709}, f::Symbol)
...
function Base.getproperty(x::__JL_Ctag_709, f::Symbol)
    r = Ref{__JL_Ctag_709}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_709}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_709}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
struct __JL_Ctag_723
    si_pid::__pid_t
    si_uid::__uid_t
end
function Base.getproperty(x::Ptr{__JL_Ctag_723}, f::Symbol)
    f === :si_pid && return Ptr{__pid_t}(x + 0)
    f === :si_uid && return Ptr{__uid_t}(x + 4)
    return getfield(x, f)
end

function Base.getproperty(x::__JL_Ctag_723, f::Symbol)
    r = Ref{__JL_Ctag_723}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_723}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_723}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct __JL_Ctag_724
    si_tid::Cint
    si_overrun::Cint
    si_sigval::sigval_t
end
function Base.getproperty(x::Ptr{__JL_Ctag_724}, f::Symbol)
...
function Base.getproperty(x::__JL_Ctag_724, f::Symbol)
    r = Ref{__JL_Ctag_724}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_724}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_724}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct __JL_Ctag_725
    si_pid::__pid_t
    si_uid::__uid_t
    si_sigval::sigval_t
end
function Base.getproperty(x::Ptr{__JL_Ctag_725}, f::Symbol)
    f === :si_pid && return Ptr{__pid_t}(x + 0)
    f === :si_uid && return Ptr{__uid_t}(x + 4)
    f === :si_sigval && return Ptr{sigval_t}(x + 8)
    return getfield(x, f)
...
function Base.getproperty(x::__JL_Ctag_725, f::Symbol)
    r = Ref{__JL_Ctag_725}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_725}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_725}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct __JL_Ctag_726
    si_pid::__pid_t
    si_uid::__uid_t
    si_status::Cint
    si_utime::__clock_t
...
function Base.getproperty(x::Ptr{__JL_Ctag_726}, f::Symbol)
    f === :si_pid && return Ptr{__pid_t}(x + 0)
    f === :si_uid && return Ptr{__uid_t}(x + 4)
...
function Base.getproperty(x::__JL_Ctag_726, f::Symbol)
    r = Ref{__JL_Ctag_726}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_726}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_726}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct __JL_Ctag_727
    si_addr::Ptr{Cvoid}
    si_addr_lsb::Cshort
end
function Base.getproperty(x::Ptr{__JL_Ctag_727}, f::Symbol)
    f === :si_addr && return Ptr{Ptr{Cvoid}}(x + 0)
    f === :si_addr_lsb && return Ptr{Cshort}(x + 4)
    return getfield(x, f)
end

function Base.getproperty(x::__JL_Ctag_727, f::Symbol)
    r = Ref{__JL_Ctag_727}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_727}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_727}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct __JL_Ctag_728
    si_band::Clong
    si_fd::Cint
end
function Base.getproperty(x::Ptr{__JL_Ctag_728}, f::Symbol)
    f === :si_band && return Ptr{Clong}(x + 0)
    f === :si_fd && return Ptr{Cint}(x + 4)
    return getfield(x, f)
end

function Base.getproperty(x::__JL_Ctag_728, f::Symbol)
    r = Ref{__JL_Ctag_728}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_728}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_728}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct __JL_Ctag_729
    _call_addr::Ptr{Cvoid}
    _syscall::Cint
    _arch::Cuint
end
function Base.getproperty(x::Ptr{__JL_Ctag_729}, f::Symbol)
...
function Base.getproperty(x::__JL_Ctag_729, f::Symbol)
    r = Ref{__JL_Ctag_729}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_729}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_729}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
