...
function Base.getproperty(x::Ptr{pthread_cond_t}, f::Symbol)
    f === :__data && return Ptr{__JL_Ctag_707}(x + 0)
...
function Base.getproperty(x::Ptr{__JL_Ctag_726}, f::Symbol)
    ...
    f === :_kill && return Ptr{__JL_Ctag_727}(x + 0)
    f === :_timer && return Ptr{__JL_Ctag_728}(x + 0)
    f === :_rt && return Ptr{__JL_Ctag_729}(x + 0)
    f === :_sigchld && return Ptr{__JL_Ctag_730}(x + 0)
    f === :_sigfault && return Ptr{__JL_Ctag_731}(x + 0)
    f === :_sigpoll && return Ptr{__JL_Ctag_732}(x + 0)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{siginfo}, f::Symbol)
    ...
    f === :_sifields && return Ptr{__JL_Ctag_726}(x + 12)
    return getfield(x, f)
end
...
struct __JL_Ctag_713
    data::NTuple{4, UInt8}
end

function Base.getproperty(x::Ptr{__JL_Ctag_713}, f::Symbol)
    f === :scheduled && return Ptr{Bool}(x + 0)
    f === :reserved && return Ptr{Csize_t}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::__JL_Ctag_713, f::Symbol)
    r = Ref{__JL_Ctag_713}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_713}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_713}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_task}, f::Symbol)
    ...
    f === :abi_extension && return Ptr{__JL_Ctag_713}(x + 32)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{aws_io_handle}, f::Symbol)
    f === :data && return Ptr{__JL_Ctag_723}(x + 0)
...
@cenum __JL_Ctag_259::UInt32 begin
...
function Base.getproperty(x::Ptr{__JL_Ctag_711}, f::Symbol)
...
function Base.getproperty(x::__JL_Ctag_711, f::Symbol)
    r = Ref{__JL_Ctag_711}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_711}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_711}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_async_input_stream_tester}, f::Symbol)
    ...
    f === :synced_data && return Ptr{__JL_Ctag_711}(x + 96)
...
function Base.getproperty(x::Ptr{__JL_Ctag_707}, f::Symbol)
...
function Base.getproperty(x::__JL_Ctag_707, f::Symbol)
    r = Ref{__JL_Ctag_707}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_707}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_707}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
struct __JL_Ctag_731
    si_addr::Ptr{Cvoid}
end
function Base.getproperty(x::Ptr{__JL_Ctag_731}, f::Symbol)
    f === :si_addr && return Ptr{Ptr{Cvoid}}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::__JL_Ctag_731, f::Symbol)
    r = Ref{__JL_Ctag_731}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_731}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_731}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct __JL_Ctag_732
    si_band::Clong
    si_fd::Cint
end
function Base.getproperty(x::Ptr{__JL_Ctag_732}, f::Symbol)
    f === :si_band && return Ptr{Clong}(x + 0)
    f === :si_fd && return Ptr{Cint}(x + 4)
    return getfield(x, f)
end

function Base.getproperty(x::__JL_Ctag_732, f::Symbol)
    r = Ref{__JL_Ctag_732}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_732}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_732}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
