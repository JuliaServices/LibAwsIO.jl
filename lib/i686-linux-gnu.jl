...
function Base.getproperty(x::Ptr{aws_io_handle}, f::Symbol)
    f === :data && return Ptr{__JL_Ctag_705}(x + 0)
...
function Base.getproperty(x::Ptr{__JL_Ctag_708}, f::Symbol)
...
function Base.getproperty(x::__JL_Ctag_708, f::Symbol)
    r = Ref{__JL_Ctag_708}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_708}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_708}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_async_input_stream_tester}, f::Symbol)
    ...
    f === :synced_data && return Ptr{__JL_Ctag_708}(x + 96)
...
function Base.getproperty(x::Ptr{__JL_Ctag_685}, f::Symbol)
...
function Base.getproperty(x::__JL_Ctag_685, f::Symbol)
    r = Ref{__JL_Ctag_685}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_685}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_685}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
