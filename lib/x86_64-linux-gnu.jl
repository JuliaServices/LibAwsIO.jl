...
function Base.getproperty(x::Ptr{pthread_cond_t}, f::Symbol)
    f === :__data && return Ptr{__JL_Ctag_1224}(x + 0)
...
function Base.getproperty(x::Ptr{__JL_Ctag_1305}, f::Symbol)
    ...
    f === :_kill && return Ptr{__JL_Ctag_1306}(x + 0)
    f === :_timer && return Ptr{__JL_Ctag_1307}(x + 0)
    f === :_rt && return Ptr{__JL_Ctag_1308}(x + 0)
    f === :_sigchld && return Ptr{__JL_Ctag_1309}(x + 0)
    f === :_sigfault && return Ptr{__JL_Ctag_1310}(x + 0)
    f === :_sigpoll && return Ptr{__JL_Ctag_1311}(x + 0)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{siginfo}, f::Symbol)
    ...
    f === :_sifields && return Ptr{__JL_Ctag_1305}(x + 16)
    return getfield(x, f)
end
...
struct __JL_Ctag_1268
    data::NTuple{8, UInt8}
end

function Base.getproperty(x::Ptr{__JL_Ctag_1268}, f::Symbol)
    f === :scheduled && return Ptr{Bool}(x + 0)
    f === :reserved && return Ptr{Csize_t}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::__JL_Ctag_1268, f::Symbol)
    r = Ref{__JL_Ctag_1268}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_1268}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_1268}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_task}, f::Symbol)
    ...
    f === :abi_extension && return Ptr{__JL_Ctag_1268}(x + 56)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{__JL_Ctag_1224}, f::Symbol)
    f === :__lock && return Ptr{Cint}(x + 0)
...
function Base.getproperty(x::__JL_Ctag_1224, f::Symbol)
    r = Ref{__JL_Ctag_1224}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_1224}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_1224}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
