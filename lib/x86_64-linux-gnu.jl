...
function Base.getproperty(x::Ptr{pthread_cond_t}, f::Symbol)
    f === :__data && return Ptr{__JL_Ctag_705}(x + 0)
...
function Base.getproperty(x::Ptr{__JL_Ctag_724}, f::Symbol)
    ...
    f === :_kill && return Ptr{__JL_Ctag_725}(x + 0)
    f === :_timer && return Ptr{__JL_Ctag_726}(x + 0)
    f === :_rt && return Ptr{__JL_Ctag_727}(x + 0)
    f === :_sigchld && return Ptr{__JL_Ctag_728}(x + 0)
    f === :_sigfault && return Ptr{__JL_Ctag_729}(x + 0)
    f === :_sigpoll && return Ptr{__JL_Ctag_730}(x + 0)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{siginfo}, f::Symbol)
    ...
    f === :_sifields && return Ptr{__JL_Ctag_724}(x + 16)
    return getfield(x, f)
end
...
struct __JL_Ctag_712
    data::NTuple{8, UInt8}
end

function Base.getproperty(x::Ptr{__JL_Ctag_712}, f::Symbol)
    f === :scheduled && return Ptr{Bool}(x + 0)
    f === :reserved && return Ptr{Csize_t}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::__JL_Ctag_712, f::Symbol)
    r = Ref{__JL_Ctag_712}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_712}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_712}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_task}, f::Symbol)
    ...
    f === :abi_extension && return Ptr{__JL_Ctag_712}(x + 56)
    return getfield(x, f)
end
...
struct __JL_Ctag_721
    data::NTuple{8, UInt8}
end

function Base.getproperty(x::Ptr{__JL_Ctag_721}, f::Symbol)
    f === :fd && return Ptr{Cint}(x + 0)
    f === :handle && return Ptr{Ptr{Cvoid}}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::__JL_Ctag_721, f::Symbol)
    r = Ref{__JL_Ctag_721}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_721}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_721}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_io_handle}, f::Symbol)
    f === :data && return Ptr{__JL_Ctag_721}(x + 0)
...
function Base.getproperty(x::Ptr{aws_async_input_stream_tester}, f::Symbol)
    ...
    f === :synced_data && return Ptr{__JL_Ctag_709}(x + 184)
