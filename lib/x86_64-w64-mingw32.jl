...
function Base.getproperty(x::Ptr{aws_task}, f::Symbol)
    ...
    f === :abi_extension && return Ptr{__JL_Ctag_332}(x + 56)
    return getfield(x, f)
end
...
struct __JL_Ctag_333
    data::NTuple{8, UInt8}
end

function Base.getproperty(x::Ptr{__JL_Ctag_333}, f::Symbol)
    f === :fd && return Ptr{Cint}(x + 0)
    f === :handle && return Ptr{Ptr{Cvoid}}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::__JL_Ctag_333, f::Symbol)
    r = Ref{__JL_Ctag_333}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_333}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_333}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_io_handle}, f::Symbol)
    f === :data && return Ptr{__JL_Ctag_333}(x + 0)
...
function aws_string_convert_to_wstring(allocator, to_convert)
    ccall((:aws_string_convert_to_wstring, libaws_c_io), Ptr{aws_wstring}, (Ptr{aws_allocator}, Ptr{aws_string}), allocator, to_convert)
end
...
function aws_string_convert_to_wchar_from_byte_cursor(allocator, to_convert)
    ccall((:aws_string_convert_to_wchar_from_byte_cursor, libaws_c_io), Ptr{aws_wstring}, (Ptr{aws_allocator}, Ptr{aws_byte_cursor}), allocator, to_convert)
end
...
function aws_wstring_destroy(str)
    ccall((:aws_wstring_destroy, libaws_c_io), Cvoid, (Ptr{aws_wstring},), str)
end
...
function aws_string_convert_from_wchar_str(allocator, to_convert)
    ccall((:aws_string_convert_from_wchar_str, libaws_c_io), Ptr{aws_string}, (Ptr{aws_allocator}, Ptr{aws_wstring}), allocator, to_convert)
end
...
function aws_string_convert_from_wchar_byte_cursor(allocator, to_convert)
    ccall((:aws_string_convert_from_wchar_byte_cursor, libaws_c_io), Ptr{aws_string}, (Ptr{aws_allocator}, Ptr{aws_byte_cursor}), allocator, to_convert)
end
...
function aws_string_convert_from_wchar_c_str(allocator, to_convert)
    ccall((:aws_string_convert_from_wchar_c_str, libaws_c_io), Ptr{aws_string}, (Ptr{aws_allocator}, Ptr{Cwchar_t}), allocator, to_convert)
end
...
function aws_wstring_new_from_cursor(allocator, w_str_cur)
    ccall((:aws_wstring_new_from_cursor, libaws_c_io), Ptr{aws_wstring}, (Ptr{aws_allocator}, Ptr{aws_byte_cursor}), allocator, w_str_cur)
end
...
function aws_wstring_new_from_array(allocator, w_str, length)
    ccall((:aws_wstring_new_from_array, libaws_c_io), Ptr{aws_wstring}, (Ptr{aws_allocator}, Ptr{Cwchar_t}, Csize_t), allocator, w_str, length)
end
...
function aws_wstring_c_str(str)
    ccall((:aws_wstring_c_str, libaws_c_io), Ptr{Cwchar_t}, (Ptr{aws_wstring},), str)
end
...
function aws_wstring_num_chars(str)
    ccall((:aws_wstring_num_chars, libaws_c_io), Csize_t, (Ptr{aws_wstring},), str)
end
...
function aws_wstring_size_bytes(str)
    ccall((:aws_wstring_size_bytes, libaws_c_io), Csize_t, (Ptr{aws_wstring},), str)
end
...
function aws_wstring_is_valid(str)
    ccall((:aws_wstring_is_valid, libaws_c_io), Bool, (Ptr{aws_wstring},), str)
end
...
```
"""
function aws_check_and_init_winsock()
    ccall((:aws_check_and_init_winsock, libaws_c_io), Cvoid, ())
end
...
```
"""
function aws_winsock_get_connectex_fn()
    ccall((:aws_winsock_get_connectex_fn, libaws_c_io), aws_ms_fn_ptr, ())
end
...
```
"""
function aws_winsock_get_acceptex_fn()
    ccall((:aws_winsock_get_acceptex_fn, libaws_c_io), aws_ms_fn_ptr, ())
end
...
function Base.getproperty(x::Ptr{aws_async_input_stream_tester}, f::Symbol)
    ...
    f === :synced_data && return Ptr{__JL_Ctag_331}(x + 192)
...
function s_test_print_stack_trace(exception_pointers)
    ccall((:s_test_print_stack_trace, libaws_c_io), LONG, (Ptr{Cvoid},), exception_pointers)
end
