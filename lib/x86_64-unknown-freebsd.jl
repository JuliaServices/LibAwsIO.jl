...
function pthread_once(arg1, arg2)
    ccall((:pthread_once, libaws_c_io), Cint, (Ptr{pthread_once_t}, Ptr{Cvoid}), arg1, arg2)
end
...
function Base.getproperty(x::Ptr{aws_task}, f::Symbol)
    ...
    f === :abi_extension && return Ptr{__JL_Ctag_236}(x + 56)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{aws_io_handle}, f::Symbol)
    f === :data && return Ptr{__JL_Ctag_237}(x + 0)
...
function Base.getproperty(x::Ptr{aws_async_input_stream_tester}, f::Symbol)
    ...
    f === :synced_data && return Ptr{__JL_Ctag_235}(x + 184)
