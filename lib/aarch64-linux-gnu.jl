...
function Base.getproperty(x::Ptr{pthread_cond_t}, f::Symbol)
    f === :__data && return Ptr{__JL_Ctag_710}(x + 0)
    f === :__size && return Ptr{NTuple{48, Cchar}}(x + 0)
    f === :__align && return Ptr{Clong}(x + 0)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{__JL_Ctag_723}, f::Symbol)
    ...
    f === :_kill && return Ptr{__JL_Ctag_724}(x + 0)
    f === :_timer && return Ptr{__JL_Ctag_725}(x + 0)
    f === :_rt && return Ptr{__JL_Ctag_726}(x + 0)
    f === :_sigchld && return Ptr{__JL_Ctag_727}(x + 0)
    f === :_sigfault && return Ptr{__JL_Ctag_728}(x + 0)
    f === :_sigpoll && return Ptr{__JL_Ctag_729}(x + 0)
    f === :_sigsys && return Ptr{__JL_Ctag_730}(x + 0)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{siginfo_t}, f::Symbol)
    ...
    f === :_sifields && return Ptr{__JL_Ctag_723}(x + 16)
    return getfield(x, f)
end
...
struct __JL_Ctag_718
    data::NTuple{8, UInt8}
end

function Base.getproperty(x::Ptr{__JL_Ctag_718}, f::Symbol)
    f === :scheduled && return Ptr{Bool}(x + 0)
    f === :reserved && return Ptr{Csize_t}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::__JL_Ctag_718, f::Symbol)
    r = Ref{__JL_Ctag_718}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_718}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_718}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_task}, f::Symbol)
    ...
    f === :abi_extension && return Ptr{__JL_Ctag_718}(x + 56)
    return getfield(x, f)
end
...
struct __JL_Ctag_734
    data::NTuple{8, UInt8}
end

function Base.getproperty(x::Ptr{__JL_Ctag_734}, f::Symbol)
    f === :fd && return Ptr{Cint}(x + 0)
    f === :handle && return Ptr{Ptr{Cvoid}}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::__JL_Ctag_734, f::Symbol)
    r = Ref{__JL_Ctag_734}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_734}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_734}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_io_handle}, f::Symbol)
    f === :data && return Ptr{__JL_Ctag_734}(x + 0)
...
function Base.getproperty(x::Ptr{__JL_Ctag_715}, f::Symbol)
...
function Base.getproperty(x::__JL_Ctag_715, f::Symbol)
    r = Ref{__JL_Ctag_715}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_715}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_715}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_async_input_stream_tester}, f::Symbol)
    ...
    f === :synced_data && return Ptr{__JL_Ctag_715}(x + 184)
...
function Base.getproperty(x::Ptr{__JL_Ctag_710}, f::Symbol)
...
function Base.getproperty(x::__JL_Ctag_710, f::Symbol)
    r = Ref{__JL_Ctag_710}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_710}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_710}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
struct __JL_Ctag_730
    _call_addr::Ptr{Cvoid}
    _syscall::Cint
    _arch::Cuint
end
function Base.getproperty(x::Ptr{__JL_Ctag_730}, f::Symbol)
...
function Base.getproperty(x::__JL_Ctag_730, f::Symbol)
    r = Ref{__JL_Ctag_730}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_730}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_730}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
