...
function aws_wrapped_cf_allocator_new(allocator)
    ccall((:aws_wrapped_cf_allocator_new, libaws_c_io), CFAllocatorRef, (Ptr{aws_allocator},), allocator)
end
...
function aws_wrapped_cf_allocator_destroy(allocator)
    ccall((:aws_wrapped_cf_allocator_destroy, libaws_c_io), Cvoid, (CFAllocatorRef,), allocator)
end
...
function Base.getproperty(x::Ptr{aws_task}, f::Symbol)
    ...
    f === :abi_extension && return Ptr{__JL_Ctag_221}(x + 56)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{aws_io_handle}, f::Symbol)
    f === :data && return Ptr{__JL_Ctag_222}(x + 0)
...
function Base.getproperty(x::Ptr{aws_async_input_stream_tester}, f::Symbol)
    ...
    f === :synced_data && return Ptr{__JL_Ctag_220}(x + 184)
