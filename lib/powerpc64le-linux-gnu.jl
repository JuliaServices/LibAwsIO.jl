...
function Base.getproperty(x::Ptr{pthread_cond_t}, f::Symbol)
    f === :__data && return Ptr{__JL_Ctag_1184}(x + 0)
...
function Base.getproperty(x::Ptr{pthread_rwlock_t}, f::Symbol)
    f === :__data && return Ptr{__JL_Ctag_1185}(x + 0)
...
function Base.getproperty(x::Ptr{__JL_Ctag_1238}, f::Symbol)
    ...
    f === :_kill && return Ptr{__JL_Ctag_1239}(x + 0)
    f === :_timer && return Ptr{__JL_Ctag_1240}(x + 0)
    f === :_rt && return Ptr{__JL_Ctag_1241}(x + 0)
    f === :_sigchld && return Ptr{__JL_Ctag_1242}(x + 0)
    f === :_sigfault && return Ptr{__JL_Ctag_1243}(x + 0)
    f === :_sigpoll && return Ptr{__JL_Ctag_1244}(x + 0)
    f === :_sigsys && return Ptr{__JL_Ctag_1245}(x + 0)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{siginfo_t}, f::Symbol)
    ...
    f === :_sifields && return Ptr{__JL_Ctag_1238}(x + 16)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{aws_task}, f::Symbol)
    ...
    f === :abi_extension && return Ptr{__JL_Ctag_1222}(x + 56)
    return getfield(x, f)
end
...
function s_print_stack_trace(sig, sig_info, user_data)
    ccall((:s_print_stack_trace, libaws_c_common), Cvoid, (Cint, Ptr{siginfo_t}, Ptr{Cvoid}), sig, sig_info, user_data)
end
...
struct __JL_Ctag_1243
    si_addr::Ptr{Cvoid}
end
function Base.getproperty(x::Ptr{__JL_Ctag_1243}, f::Symbol)
    f === :si_addr && return Ptr{Ptr{Cvoid}}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::__JL_Ctag_1243, f::Symbol)
    r = Ref{__JL_Ctag_1243}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_1243}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_1243}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct __JL_Ctag_1244
    si_band::Clong
    si_fd::Cint
end
function Base.getproperty(x::Ptr{__JL_Ctag_1244}, f::Symbol)
    f === :si_band && return Ptr{Clong}(x + 0)
    f === :si_fd && return Ptr{Cint}(x + 8)
    return getfield(x, f)
end

function Base.getproperty(x::__JL_Ctag_1244, f::Symbol)
    r = Ref{__JL_Ctag_1244}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_1244}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_1244}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct __JL_Ctag_1245
    _call_addr::Ptr{Cvoid}
    _syscall::Cint
    _arch::Cuint
end
function Base.getproperty(x::Ptr{__JL_Ctag_1245}, f::Symbol)
...
function Base.getproperty(x::__JL_Ctag_1245, f::Symbol)
    r = Ref{__JL_Ctag_1245}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_1245}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_1245}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
