...
function Base.getproperty(x::Ptr{pthread_cond_t}, f::Symbol)
    f === :__data && return Ptr{__JL_Ctag_688}(x + 0)
...
struct __JL_Ctag_692
    data::NTuple{112, UInt8}
end

function Base.getproperty(x::Ptr{__JL_Ctag_692}, f::Symbol)
    f === :_pad && return Ptr{NTuple{28, Cint}}(x + 0)
    f === :_kill && return Ptr{__JL_Ctag_693}(x + 0)
    f === :_timer && return Ptr{__JL_Ctag_694}(x + 0)
    f === :_rt && return Ptr{__JL_Ctag_695}(x + 0)
    f === :_sigchld && return Ptr{__JL_Ctag_696}(x + 0)
    f === :_sigfault && return Ptr{__JL_Ctag_697}(x + 0)
    f === :_sigpoll && return Ptr{__JL_Ctag_698}(x + 0)
    f === :_sigsys && return Ptr{__JL_Ctag_699}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::__JL_Ctag_692, f::Symbol)
    r = Ref{__JL_Ctag_692}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_692}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_692}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{siginfo_t}, f::Symbol)
    ...
    f === :_sifields && return Ptr{__JL_Ctag_692}(x + 16)
    return getfield(x, f)
end
...
struct __JL_Ctag_706
    data::NTuple{8, UInt8}
end

function Base.getproperty(x::Ptr{__JL_Ctag_706}, f::Symbol)
    f === :scheduled && return Ptr{Bool}(x + 0)
    f === :reserved && return Ptr{Csize_t}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::__JL_Ctag_706, f::Symbol)
    r = Ref{__JL_Ctag_706}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_706}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_706}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_task}, f::Symbol)
    ...
    f === :abi_extension && return Ptr{__JL_Ctag_706}(x + 56)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{aws_io_handle}, f::Symbol)
    f === :data && return Ptr{__JL_Ctag_714}(x + 0)
...
@cenum __JL_Ctag_251::UInt32 begin
...
function Base.getproperty(x::Ptr{__JL_Ctag_703}, f::Symbol)
...
function Base.getproperty(x::__JL_Ctag_703, f::Symbol)
    r = Ref{__JL_Ctag_703}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_703}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_703}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
...
function Base.getproperty(x::Ptr{aws_async_input_stream_tester}, f::Symbol)
    ...
    f === :synced_data && return Ptr{__JL_Ctag_703}(x + 184)
...
function Base.getproperty(x::Ptr{__JL_Ctag_688}, f::Symbol)
...
function Base.getproperty(x::__JL_Ctag_688, f::Symbol)
    r = Ref{__JL_Ctag_688}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_688}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_688}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct __JL_Ctag_693
    si_pid::__pid_t
    si_uid::__uid_t
end
function Base.getproperty(x::Ptr{__JL_Ctag_693}, f::Symbol)
    f === :si_pid && return Ptr{__pid_t}(x + 0)
    f === :si_uid && return Ptr{__uid_t}(x + 4)
    return getfield(x, f)
end

function Base.getproperty(x::__JL_Ctag_693, f::Symbol)
    r = Ref{__JL_Ctag_693}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_693}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_693}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct __JL_Ctag_694
    si_tid::Cint
    si_overrun::Cint
    si_sigval::sigval_t
end
function Base.getproperty(x::Ptr{__JL_Ctag_694}, f::Symbol)
...
function Base.getproperty(x::__JL_Ctag_694, f::Symbol)
    r = Ref{__JL_Ctag_694}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_694}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_694}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct __JL_Ctag_695
    si_pid::__pid_t
    si_uid::__uid_t
    si_sigval::sigval_t
end
function Base.getproperty(x::Ptr{__JL_Ctag_695}, f::Symbol)
    f === :si_pid && return Ptr{__pid_t}(x + 0)
    f === :si_uid && return Ptr{__uid_t}(x + 4)
    f === :si_sigval && return Ptr{sigval_t}(x + 8)
    return getfield(x, f)
...
function Base.getproperty(x::__JL_Ctag_695, f::Symbol)
    r = Ref{__JL_Ctag_695}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_695}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_695}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct __JL_Ctag_696
    si_pid::__pid_t
    si_uid::__uid_t
    si_status::Cint
    si_utime::__clock_t
...
function Base.getproperty(x::Ptr{__JL_Ctag_696}, f::Symbol)
    f === :si_pid && return Ptr{__pid_t}(x + 0)
    f === :si_uid && return Ptr{__uid_t}(x + 4)
...
function Base.getproperty(x::__JL_Ctag_696, f::Symbol)
    r = Ref{__JL_Ctag_696}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_696}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_696}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct __JL_Ctag_697
    si_addr::Ptr{Cvoid}
end
function Base.getproperty(x::Ptr{__JL_Ctag_697}, f::Symbol)
    f === :si_addr && return Ptr{Ptr{Cvoid}}(x + 0)
    return getfield(x, f)
end

function Base.getproperty(x::__JL_Ctag_697, f::Symbol)
    r = Ref{__JL_Ctag_697}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_697}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_697}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct __JL_Ctag_698
    si_band::Clong
    si_fd::Cint
end
function Base.getproperty(x::Ptr{__JL_Ctag_698}, f::Symbol)
    f === :si_band && return Ptr{Clong}(x + 0)
    f === :si_fd && return Ptr{Cint}(x + 8)
    return getfield(x, f)
end

function Base.getproperty(x::__JL_Ctag_698, f::Symbol)
    r = Ref{__JL_Ctag_698}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_698}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_698}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end


struct __JL_Ctag_699
    _call_addr::Ptr{Cvoid}
    _syscall::Cint
    _arch::Cuint
end
function Base.getproperty(x::Ptr{__JL_Ctag_699}, f::Symbol)
...
function Base.getproperty(x::__JL_Ctag_699, f::Symbol)
    r = Ref{__JL_Ctag_699}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_699}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_699}, f::Symbol, v)
    unsafe_store!(getproperty(x, f), v)
end
